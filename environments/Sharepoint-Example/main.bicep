...
param timeZone string = 'Central Europe Standard Time'
...
param vmDcStorage string = 'Standard_LRS'
...
param vmSqlStorage string = 'Standard_LRS'
...
param vmSharePointStorage string = 'Standard_LRS'
